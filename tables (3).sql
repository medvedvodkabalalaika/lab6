...
INSERT INTO 'worker' VALUES(2,2,'тайлер дерден',15000,'продавец-консультант');
...
INSERT INTO 'worker' VALUES(19,1,'Алексей Самутин',41,'продавец-стажер');
INSERT INTO 'worker' VALUES(21,2,'рамзан',17000,'продавец-консультант');
INSERT INTO 'worker' VALUES(31,1,'шошкин',2,'щетка для поломоечной машины керхер');
INSERT INTO 'worker' VALUES(60,1,'КиИБ',17000,'щетка для поломоечной машины керхер');
